...
class TEmuVt102 : public TEmu
{
public:

   TEmuVt102(int columns = 80, int lines = 25);
  ~TEmuVt102();
...
public:
  ...
  void changeSize(int columns, int lines);
...
protected: //FIXME: added from TEmulation, rework
...
public: // added access for restore feature

  const TEScreen* getScreen(int n) const;
};
